...
type getBlockBodiesFn func(uint64, []common.Hash) error
type getCodeFn func(uint64, []*CodeReq) error
type getReceiptsFn func(uint64, []common.Hash) error
type getProofsFn func(uint64, []*ProofReq) error
...
func newOdrPeer(id string, version int, head common.Hash, getBlockBodies getBlockBodiesFn, getCode getCodeFn, getReceipts getReceiptsFn, getProofs getProofsFn) *odrPeer {
	return &odrPeer{
		id:             id,
		head:           head,
